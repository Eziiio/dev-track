...
function TasksPlaceholder() {
  return (
    <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-12 text-center max-w-2xl mx-auto space-y-4 shadow-sm mt-8">
      ...
      <h2 className="font-display text-2xl font-bold">Tasks Management</h2>
      <p className="text-slate-500 dark:text-slate-400 text-sm max-w-sm mx-auto">
        Track progress, update task statuses, assign items, and filter lists. This feature is coming in **Phase 11: Task Management UI**.
      </p>
    </div>
  );
}
